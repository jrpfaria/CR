        ...
        if (rising_edge (S_AXIS_ACLK)) then
            if (S_AXIS_ARESETN = '0') then
               ...
               if (s_ready = '1') then --prontos a consumir
                    ...
                    s_dataOut  <= std_logic_vector(to_unsigned(
                                  (to_integer(signed(S_AXIS_TDATA(23 downto 16))) - to_integer(signed(S_AXIS_TDATA(7 downto 0)))) 
                                * (to_integer(signed(S_AXIS_TDATA(23 downto 16))) - to_integer(signed(S_AXIS_TDATA(7 downto 0)))) 
                                + (to_integer(signed(S_AXIS_TDATA(31 downto 24))) - to_integer(signed(S_AXIS_TDATA(15 downto 8)))) 
                                * (to_integer(signed(S_AXIS_TDATA(31 downto 24))) - to_integer(signed(S_AXIS_TDATA(15 downto 8)))), 32));
                    s_validOut <= '1';
